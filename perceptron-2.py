...
accuracy_perceptron = -1;
accuracy_MLPClassifier = -1;
for w in n: #iterates over n
    for b in r: #iterates over r
        ...
        for a in range(2): #iterates over the algorithms
            ...
            #--> add your Python code here
            if a==0:
                if acc > accuracy_perceptron:
                    accuracy_perceptron = acc
                    print("Highest Perceptron accuracy so far: " +str(accuracy_perceptron) + ", Parameters: learning rate= " +str( w) + ", shuffle=", b)
            else:
                if acc > accuracy_MLPClassifier:
                    accuracy_MLPClassifier = acc
                    print("Highest MLP accuracy accuracy so far: " + str(accuracy_MLPClassifier) + ", Parameters: learning rate= " + str(w) + ", shuffle=" , b)
